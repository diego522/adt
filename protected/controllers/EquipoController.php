    ...
    public function actionCreate($id) {
        ...
        if (!empty($id_usuario)) {
            ...
            if ($usuario != NULL) {
                ...
                if ($concurso != NULL) {
                    if ($concurso->verificaDisponibilidadDePlazo()) {
                        ...
                        Yii::app()->user->setFlash('error', "Concurso no disponible");
                    }
                } else {
                    Yii::app()->user->setFlash('error', "Concurso inválido");
                }
            } else {
                Yii::app()->user->setFlash('error', "Problemas con el usuario");
            }
        }
