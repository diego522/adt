...
class TipoEstado extends CActiveRecord {
    ...
    public static $PROYECTO = 1;
    public static $PROPUESTA = 2;
    public static $PROCESO = 3;
    public static $SOLICITUD = 5;
    public static $PRESENTACION= 6;
    public static $PLANIFICACION = 7;
    public static $ESTADO_AVANCE = 4;
    public static $EVALUACION = 9;
    ...
    public function relations() {
        ...
        return array(
            'estados' => array(self::HAS_MANY, 'Estado', 'id_tipo_estado'),
        );
    }
