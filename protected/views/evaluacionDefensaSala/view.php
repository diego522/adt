...
<h1>Detalle de la  Evaluación del Profesor Sala en la Defensa </h1>
    ...
    'attributes' => array(
       array('name' => 'id_proyecto',
        ...
        array('name' => 'id_alumno',
         ...
         array('label' => 'Profesor Sala',
            'value' => $model->idProyecto->profSala!=NULL?$model->idProyecto->profSala->nombre:''),
        //'id_creador',
