...
<div class="form">
    ...
    <div class="row">
        ...
        <?php echo $form->dropDownList($model, 'estado', CHtml::listData(Estado::model()->findAll('id_tipo_estado='.TipoEstado::$SOLICITUD.' and id_estado not in('.implode(',', array( Estado::$SOLICITUD_APROBADA)).')'), 'id_estado', 'nombre')); ?>
