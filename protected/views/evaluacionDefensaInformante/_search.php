...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'id_evaluacion_defensa_informante'); ?>
		<?php echo $form->textField($model,'id_evaluacion_defensa_informante'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'id_evaluacion_defensa_informante_padre'); ?>
		<?php echo $form->textField($model,'id_evaluacion_defensa_informante_padre'); ?>
	</div>
