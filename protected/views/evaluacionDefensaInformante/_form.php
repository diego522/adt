...
<div class="form" style="width:700px;" >
    ...
    $form = $this->beginWidget('CActiveForm', array(
        'id' => 'evaluacion-defensa-informante-form',
    ...
    <div class="row buttons">
        ...
        if ($model->isNewRecord) {
            ...
            echo CHtml::submitButton('Guardar cambios', array(
                'submit' => array('update', 'id' => $model->id_evaluacion_defensa_informante),
                'style' => 'display:none;')
            );
            ...
            echo CHtml::submitButton('Guardar y Enviar', array(
                'submit' => array('updateYRevision', 'id' => $model->id_evaluacion_defensa_informante),
                    //'confirm' => '¿Seguro que desea enviar la evaluación?, después ya no podrá editarla'
                    // or you can use 'params'=>array('id'=>$id)
                    )
            );
