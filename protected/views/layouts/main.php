        ...
        <div id="mainMbMenu" class="barramenu">
            <div class="menujerarquico" >
                ...
                $this->widget('application.extensions.mbmenu.MbMenu', array(
                    'items' => array(
                        //array('label' => 'Inicio', 'url' => 'http://arrau.chillan.ubiobio.cl/sistemaici'),
                        array('label' => 'Inicio', 'url' => array('/site/index')),
                        /* array('label' => 'Solicitud', 'url' => array('/solicitud/admin')), */
                        array('label' => 'Propuestas de Tema', 'items' => array(
                                array('label' => 'Crear Propuesta de Tema', 'url' => array('propuesta/create'), 'visible' => Yii::app()->user->checkeaAccesoMasivo(array(Rol::$SUPER_USUARIO, Rol::$PROFESOR, Rol::$ALUMNO, Rol::$ADMINISTRADOR))),
                                array('label' => 'Propuestas Disponibles', 'url' => array('propuesta/index'), 'visible' => Yii::app()->user->checkeaAccesoMasivo(array(Rol::$SUPER_USUARIO, Rol::$ALUMNO, Rol::$PROFESOR, Rol::$ADMINISTRADOR))),
                                array('label' => 'Mis Propuestas', 'url' => array('propuesta/misPropuestas'), 'visible' => Yii::app()->user->checkeaAccesoMasivo(array(Rol::$SUPER_USUARIO, Rol::$ALUMNO, Rol::$PROFESOR, Rol::$ADMINISTRADOR))),
                                array('label' => 'Administrar Propuestas', 'url' => array('propuesta/admin'), 'visible' => Yii::app()->user->checkeaAccesoMasivo(array(Rol::$SUPER_USUARIO, Rol::$ADMINISTRADOR, Rol::$DISENADOR))),
                                array('label' => 'Administrar Periodo Propuestas', 'url' => array('proceso/admin'), 'visible' => Yii::app()->user->checkeaAccesoMasivo(array(Rol::$SUPER_USUARIO, Rol::$ADMINISTRADOR))),
                            ), 'visible' => Yii::app()->user->checkeaAccesoMasivo(array(Rol::$SUPER_USUARIO, Rol::$ALUMNO, Rol::$PROFESOR, Rol::$ADMINISTRADOR, Rol::$DISENADOR))),
                        array('label' => 'Proyectos', 'items' => array(
                                array('label' => 'Mis Proyectos', 'url' => array('proyecto/index'),),
                                array('label' => 'Administrar Proyectos', 'url' => array('proyecto/admin'), 'visible' => Yii::app()->user->checkeaAccesoMasivo(array(Rol::$SUPER_USUARIO, Rol::$ADMINISTRADOR)),),
                                array('label' => 'Administrar Aplazamientos', 'url' => array('solicitud/admin'), 'visible' => Yii::app()->user->checkeaAccesoMasivo(array(Rol::$SUPER_USUARIO, Rol::$ADMINISTRADOR)),),
