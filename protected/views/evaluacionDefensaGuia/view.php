...
$this->breadcrumbs = array(
        ...
        //$model->id_evaluacion_defensa_guia,
);
?>

<h1>Detalle de la  Evaluación del Profesor Guía en la Defensa </h1>
<?php echo CHtml::link('<img align="middle" title="Descarga esta vista en PDF" src="' . Yii::app()->request->baseUrl . '/images/pdf_icon.png"/>', array('VerPDF','id'=>$model->id_evaluacion_defensa_guia)); ?> 
