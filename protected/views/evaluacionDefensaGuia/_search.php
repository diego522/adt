...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'id_evaluacion_defensa_guia'); ?>
		<?php echo $form->textField($model,'id_evaluacion_defensa_guia'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'id_evaluacion_defensa_guia_padre'); ?>
		<?php echo $form->textField($model,'id_evaluacion_defensa_guia_padre'); ?>
	</div>
