...
<page backtop="2mm" backbottom="2mm" backleft="20mm" backright="20mm">
    ...
    <div>
        <table width="600"  border="0" cellpadding="4" cellspacing="2" bgcolor="#000000" style="font-size:14px;";>


            <tr>
                <td rowspan="5" bgcolor="#FFFFFF">&nbsp;Aspectos Generales</td>
                <td align="center" bgcolor="#FFFFFF">&nbsp;1&nbsp;</td>
                <td bgcolor="#FFFFFF">Formalidad  (lenguaje utilizado, forma de dirigirse a los 
                    asistentes,&nbsp;<br />
...
<table width="600" border="0">
        <tr>
            ...
            <td width="208" align="center">        __________________________<br/>
                <?php echo $model->idProyecto->profGuia != NULL ? $model->idProyecto->profGuia->nombre : 'Sin Asignar'; ?><br/>
    Firma Evaluador</td>
        </tr>
    </table>
